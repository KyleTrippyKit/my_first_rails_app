...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference("Truck.count") do
      post trucks_url, params: { truck: { make: @truck.make, model: @truck.model, year: @truck.year } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { make: @truck.make, model: @truck.model, year: @truck.year } }
